...
ottrpal::include_slide("https://docs.google.com/presentation/d/1fN-efiepolGfj50pPk7DQ7yu-batzIRP6HZ2SSnxp-k/edit#slide=id.g35f391192_00")
```
...
```{r, echo=FALSE, fig.alt=''}
ottrpal::include_slide("https://docs.google.com/presentation/d/1fH9s5OLcRF5meZtFWTJe89RFvJSh125kdjhdqp5smqA/edit#slide=id.g2f6b21b1164_0_15")
```

Confirm `Barcode10_Spike2.fastq.gz` exists in your history by clicking on the Home button in the top menu

```{r, echo=FALSE, fig.alt=''}
ottrpal::include_slide("https://docs.google.com/presentation/d/1fH9s5OLcRF5meZtFWTJe89RFvJSh125kdjhdqp5smqA/edit#slide=id.g2f6b21b1164_0_25")
```
...
```{r, echo=FALSE, fig.alt=''}
ottrpal::include_slide("https://docs.google.com/presentation/d/1fH9s5OLcRF5meZtFWTJe89RFvJSh125kdjhdqp5smqA/edit#slide=id.g2f6b21b1164_0_35")
```

Wait ~25 minutes as the NanoPlot, Porechop, and fastp jobs are scheduled, run, and complete

```{r, echo=FALSE, fig.alt=''}
ottrpal::include_slide("https://docs.google.com/presentation/d/1fH9s5OLcRF5meZtFWTJe89RFvJSh125kdjhdqp5smqA/edit#slide=id.g2f6b21b1164_0_39")
```
...
```{r, echo=FALSE, fig.alt=''}
ottrpal::include_slide("https://docs.google.com/presentation/d/1fH9s5OLcRF5meZtFWTJe89RFvJSh125kdjhdqp5smqA/edit#slide=id.g2f6b21b1164_0_50")
```
...
```{r, echo=FALSE, fig.alt=''}
ottrpal::include_slide("https://docs.google.com/presentation/d/1fH9s5OLcRF5meZtFWTJe89RFvJSh125kdjhdqp5smqA/edit#slide=id.g2f6b21b1164_0_57")
```
...
```{r, echo=FALSE, fig.alt=''}
ottrpal::include_slide("https://docs.google.com/presentation/d/1fH9s5OLcRF5meZtFWTJe89RFvJSh125kdjhdqp5smqA/edit#slide=id.g2f6b21b1164_0_67")
```
